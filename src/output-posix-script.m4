...
m4_lists_foreach_optional([_ARGS_LONG,_ARGS_SHORT], [_argname,_arg_short],
	[m4_ifblank(_arg_short, [m4_fatal([Argument --]_argname[ doesn't have a short option, which is not supported in POSIX mode.])])])
