...
_translit_var()
{
	...
	# the end, replacing - with _ and making it lowercase
...
do_header()
{
	...
	elif test "$1" = "standalone_lib"; then
...
# Alter the output filename to the canonical representation of stdout (-) if it is the empty string or unset
